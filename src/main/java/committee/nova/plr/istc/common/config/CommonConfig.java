...
public class CommonConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue AUTO_REFRESH = BUILDER.comment(
            "Should we auto-refresh the question when a player joined with no one else online?",
            "Default is false"
